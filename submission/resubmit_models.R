...
message("\n")
message("------------------------------------------")
message("The script is only working for RARE-X Data: A Rare Disease Open Science Data Challenge Analysis")
message("------------------------------------------")
...
if (nrow(task_sub_df) > 0) {
  ...
  message("\nRe-submitting submissions from evaluation ", dQuote(eval_id), " and ", phase, " phase ...")
